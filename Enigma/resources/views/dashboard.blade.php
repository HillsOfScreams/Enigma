        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col-reverse sm:flex-row">
            ...
            <div class="w-full sm:w-3/4 pl-4">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <!-- Username -->
                        <div class="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-100 pb-4">John Doe</div>
                        ...
                        <div class="flex flex-col space-y-4 h-96 overflow-y-auto">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 p-4 rounded-lg bg-gray-200 dark:bg-gray-700">
                                    <div class="text-xs text-gray-500">John Doe</div>
                                    <div class="text-sm text-gray-800 dark:text-gray-100">Can you assist me with setting up my account?</div> <!-- Chat message -->
                                </div>
                            </div>
